module github.com/Snakdy/terrarium
...
require (
	...
	chainguard.dev/apko v0.19.8 // indirect
	...
	github.com/awslabs/amazon-ecr-credential-helper/ecr-login v0.0.0-20241106040604-ae6a6dd67c93 // indirect
