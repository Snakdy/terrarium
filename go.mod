module github.com/djcass44/terrarium
...
require (
	...
	github.com/djcass44/ci-tools v1.7.3 // indirect
	github.com/djcass44/nib/cli v0.0.0-20240316034255-08912f11ce84 // indirect
