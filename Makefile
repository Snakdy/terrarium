...
build-poetry:
	...
	docker run \
		...
		-c "/app/terrarium build /samples/sample-poetry --install-tool=\"poetry<2.0.0 poetry-plugin-pypi-mirror poetry-plugin-export\" --entrypoint app.py --save /app/test.tar --v=10"
